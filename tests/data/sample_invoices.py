...
INVOICE_LONG_VALUES = {
    "supplier": "Очень длинное название поставщика " * 10,
    "date": "2024-03-15",
    "number": "130-" + "Z" * 100,
    "positions": [
        {
            "name": "Очень длинное название товара " * 10,
            "quantity": 1.0,
            "unit": "очень длинная единица измерения",
            "price": 100.00,
            "sum": 100.00
        }
    ] * 5,  # Умножаем список позиций на 5
    "parser_comment": "Очень длинный комментарий " * 50
}
